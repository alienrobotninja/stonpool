...
describe('Tolk build artifacts', () => {
  it.each(['wallet', 'minter', 'faucet', 'shared_tester', 'iface_tester', 'messaging_tester', 'mock_adapter', 'draw_selection_tester', 'selection_tester', 'draw_engine', 'param_governor', 'jetton_vault', 'pool_core', 'mock_stonfi_router', 'mock_stonfi_pool', 'mock_stonfi_tester', 'yield_adapter_stonfi'])(
